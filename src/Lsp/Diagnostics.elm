module Lsp.Diagnostics exposing (Diagnostic, Position, Range, Severity, diagnosticDecoder, encodeDiagnostics, encodePosition, encodeRange, parseDiagnostics, textDocumentEncoder)
